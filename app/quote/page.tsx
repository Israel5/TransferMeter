...
const ITEM: Record<string, Record<string, [string, string]>> = {
  pt: { adults: ["adulto", "adultos"], children: ["criança", "crianças"], infants: ["bebê", "bebês"],
        ...
        booster: ["booster", "boosters"], checked: ["mala", "malas"], carry: ["mala de mão", "malas de mão"],
        backpack: ["mochila", "mochilas"], stroller: ["carrinho", "carrinhos"],
...
const T = {
  pt: { title: "Orçamento de transfer", forWhom: "Preparado para", quote: "Orçamento nº",
        ...
        review: "Confira os seus dados", edit: "Corrigir", done: "Guardar", cancel: "Cancelar",
        editHint: "Mudou alguma coisa? Ajuste aqui e o motorista fica sabendo. O preço não muda.",
        saved: "Dados atualizados. Obrigado!", saveFail: "Não foi possível guardar. Tente novamente.",
        seatsWarn: "Isto passa dos lugares do carro. O motorista vai falar consigo.",
        nothing: "Nada indicado", none: "Nenhum orçamento neste link",
  ...
  en: { title: "Transfer quote", forWhom: "Prepared for", quote: "Quote no.",
        ...
        editHint: "Something changed? Adjust it here and your driver will know. The price stays the same.",
        saved: "Details updated. Thank you!", saveFail: "That didn't save. Please try again.",
        seatsWarn: "That is more than the car seats. Your driver will be in touch.",
  ...
  fr: { title: "Devis de transfert", forWhom: "Préparé pour", quote: "Devis nº",
        ...
        editHint: "Un changement ? Ajustez ici et votre chauffeur en sera informé. Le prix ne change pas.",
        saved: "Informations mises à jour. Merci !", saveFail: "L'enregistrement a échoué. Réessayez.",
        seatsWarn: "Cela dépasse le nombre de places. Votre chauffeur vous contactera.",
